...
return new class extends Migration
{
    ...
    {
        Schema::create('dop_oji_plans', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['site', 'plan_date', 'shift'], 'idx_dop_oji_plans_site_date_shift');
            $table->index(['plan_date', 'shift'], 'idx_dop_oji_plans_date_shift');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('dop_oji_plans');
    }
};