...
@section('title', 'Pengajuan OJI — DOP Safety')
...
<div class="ds-surface-card rounded-2xl p-5 mb-6">
   <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
      ...
      <form action="{{ route('dop-safety.oji.import') }}" method="POST" enctype="multipart/form-data" class="flex flex-wrap items-end gap-2">
         @csrf
         <div>
         ...
         <table class="ds-table w-full text-sm">
            ...
            <tbody>
               ...
               <tr class="border-b border-outline-variant/10">
                  ...
                  <td class="py-3">
                     <div class="flex flex-wrap gap-2">
                        <a href="{{ route('dop-safety.oji.show', $plan) }}" class="text-primary text-xs font-bold hover:underline">Lihat</a>
                        <a href="{{ route('dop-safety.oji.edit', $plan) }}" class="text-on-surface-variant text-xs font-bold hover:underline">Edit</a>
                        <form action="{{ route('dop-safety.oji.destroy', $plan) }}" method="POST" class="inline" onsubmit="return confirm('Hapus DOP ini?')">
                           @csrf
                           @method('DELETE')
