                        ...
                        <table class="w-full text-[10px] border-collapse">
                           ...
                           <tbody>
                              ...
                              <tr class="border-b border-gray-50">
                                 ...
                                 @foreach($coverageDailyDates ?? [] as $d)
                                 @php $dateKey = $d['date'] ?? ''; $cell = ($det['days'] ?? [])[$dateKey] ?? ['covered' => 0]; @endphp
            ...
            <div class="overflow-auto max-h-[320px]">
               <table class="w-full text-[10px] border-collapse" id="coverage-table">
                  ...
                  <tbody>
                     ...
                     <tr class="border-b border-gray-50"><td class="p-2 text-gray-400" colspan="{{ 4 + count($coverageDailyDates ?? []) }}">Belum ada data lokasi.</td></tr>
                     @endif
                  </tbody>
               </table>
            </div>
