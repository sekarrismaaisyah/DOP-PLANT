...
@section('title', 'Tambah Becomline')
@section('content')
<x-page-title title="Becomline" pagetitle="Tambah Data" />
        ...
        <div class="card rounded-4">
            <div class="card-body">
                <div class="d-flex align-items-center gap-2 mb-3">
                    ...
                    <h5 class="mb-0 fw-bold">Form Tambah Becomline</h5>
                </div>

                <form action="{{ route('becomline.store') }}" method="POST">
                    @csrf
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label for="perusahaan_pemilik" class="form-label">Perusahaan Pemilik</label>
                            <input type="text" class="form-control @error('perusahaan_pemilik') is-invalid @enderror" id="perusahaan_pemilik" name="perusahaan_pemilik" value="{{ old('perusahaan_pemilik') }}" maxlength="255">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('site_operasional') is-invalid @enderror" id="site_operasional" name="site_operasional" value="{{ old('site_operasional') }}" maxlength="255">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control @error('jenis_unit_spip') is-invalid @enderror" id="jenis_unit_spip" name="jenis_unit_spip" value="{{ old('jenis_unit_spip') }}" maxlength="255">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('status_permit_spip') is-invalid @enderror" id="status_permit_spip" name="status_permit_spip" value="{{ old('status_permit_spip') }}" placeholder="PASSED / N/A" maxlength="100">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('no_registrasi') is-invalid @enderror" id="no_registrasi" name="no_registrasi" value="{{ old('no_registrasi') }}" placeholder="Contoh: BMCEX-241" maxlength="100">
