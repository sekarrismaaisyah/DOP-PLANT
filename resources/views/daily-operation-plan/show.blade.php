            ...
            <div class="card rounded-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        <a href="{{ route('daily-operation-plan.edit', $dop->id) }}" class="btn btn-warning btn-sm rounded-3">
                            <i class="bx bx-edit"></i> Edit
                        </a>
                        <a href="{{ route('daily-operation-plan.index') }}" class="btn btn-secondary btn-sm rounded-3">
