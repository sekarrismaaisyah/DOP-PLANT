...
<div class="row mt-4">
    ...
    <script>
        ...
        async function processCardFrame(cardId) {
            ...
            try {
                ...
                if (cardState.videoUrl || cardState.streamUrl) {
                    // For uploaded video, use frame count
                    // For stream, use current video time or frame count
                    if (cardState.videoUrl) {
                        videoTimeMs = cardState.frameCount * FRAME_INTERVAL;
                    } else {
                        // For streams, use video currentTime if available, otherwise frame count
                        videoTimeMs = video.currentTime ? video.currentTime * 1000 : cardState.frameCount * FRAME_INTERVAL;
                    }
        ...
        // Draw landmarks for specific card
