...
@section('title', 'Edit Insiden CCR')

@section('content')
    <x-page-title title="Edit Insiden CCR" pagetitle="Manajemen Insiden CCR" />
        ...
        <div class="col-12">
            <div class="card rounded-4">
                <div class="card-header">
                    <h5 class="mb-0">Form Edit Insiden CCR #{{ $insiden->ccr_id }}</h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('insiden-ccr.update', $insiden) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="ccr_id" id="ccr_id" 
                                       ...
                                       value="{{ old('ccr_id', $insiden->ccr_id) }}">
                                @error('ccr_id')
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="ccr_jenis_insiden" id="ccr_jenis_insiden" 
                                    ...
                                    @php
                                        ...
                                        $currentJenis = old('ccr_jenis_insiden', $insiden->ccr_jenis_insiden);
                                    @endphp
                                    @foreach($jenisOptions as $option)
                                        <option value="{{ $option }}" {{ $currentJenis == $option ? 'selected' : '' }}>
                                            {{ $option }}
                                        </option>
                                    @endforeach
                                    @if($currentJenis && !in_array($currentJenis, $jenisOptions))
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="datetime-local" name="ccr_waktu_insiden" id="ccr_waktu_insiden" 
                                       ...
                                       value="{{ old('ccr_waktu_insiden', $insiden->ccr_waktu_insiden?->format('Y-m-d\TH:i')) }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="datetime-local" name="ccr_waktu_pelaporan" id="ccr_waktu_pelaporan" 
                                       ...
                                       value="{{ old('ccr_waktu_pelaporan', $insiden->ccr_waktu_pelaporan?->format('Y-m-d\TH:i')) }}">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="ccr_kronologi" id="ccr_kronologi" rows="4" 
                                          ...
                                          placeholder="Kronologi kejadian secara detail">{{ old('ccr_kronologi', $insiden->ccr_kronologi) }}</textarea>
                                @error('ccr_kronologi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="ccr_nama_call_taker" id="ccr_nama_call_taker" 
                                       ...
                                       value="{{ old('ccr_nama_call_taker', $insiden->ccr_nama_call_taker) }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="ccr_perusahaan_call_taker" id="ccr_perusahaan_call_taker" 
                                       ...
                                       value="{{ old('ccr_perusahaan_call_taker', $insiden->ccr_perusahaan_call_taker) }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="ccr_nama_pelapor" id="ccr_nama_pelapor" 
                                       ...
                                       value="{{ old('ccr_nama_pelapor', $insiden->ccr_nama_pelapor) }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="ccr_perusahaan_pelapor" id="ccr_perusahaan_pelapor" 
                                       ...
                                       value="{{ old('ccr_perusahaan_pelapor', $insiden->ccr_perusahaan_pelapor) }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="ccr_lokasi_perusahaan" id="ccr_lokasi_perusahaan" 
                                       ...
                                       value="{{ old('ccr_lokasi_perusahaan', $insiden->ccr_lokasi_perusahaan) }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="ccr_site" id="ccr_site" 
                                    ...
                                    @php
                                        ...
                                        $currentSite = old('ccr_site', $insiden->ccr_site);
                                    @endphp
                                    @foreach($siteOptions as $option)
                                        <option value="{{ $option }}" {{ $currentSite == $option ? 'selected' : '' }}>
                                            {{ $option }}
                                        </option>
                                    @endforeach
                                    @if($currentSite && !in_array($currentSite, $siteOptions))
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="ccr_lokasi" id="ccr_lokasi" 
                                       ...
                                       value="{{ old('ccr_lokasi', $insiden->ccr_lokasi) }}">
                                @error('ccr_lokasi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="ccr_detil_lokasi" id="ccr_detil_lokasi" 
                                       ...
                                       value="{{ old('ccr_detil_lokasi', $insiden->ccr_detil_lokasi) }}">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="ccr_keterangan_lokasi" id="ccr_keterangan_lokasi" rows="2" 
                                          class="form-control @error('ccr_keterangan_lokasi') is-invalid @enderror">{{ old('ccr_keterangan_lokasi', $insiden->ccr_keterangan_lokasi) }}</textarea>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="ccr_status" id="ccr_status" 
                                    ...
                                    @php
                                        ...
                                        $currentStatus = old('ccr_status', $insiden->ccr_status);
                                    @endphp
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="ccr_pic_investigasi" id="ccr_pic_investigasi" 
                                       ...
                                       value="{{ old('ccr_pic_investigasi', $insiden->ccr_pic_investigasi) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="ccr_pic_investigasi_perusahaan" id="ccr_pic_investigasi_perusahaan" 
                                       ...
                                       value="{{ old('ccr_pic_investigasi_perusahaan', $insiden->ccr_pic_investigasi_perusahaan) }}">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="ket_not_investigasi" id="ket_not_investigasi" rows="2" 
                                          class="form-control @error('ket_not_investigasi') is-invalid @enderror">{{ old('ket_not_investigasi', $insiden->ket_not_investigasi) }}</textarea>
