<aside class="sidebar-wrapper">
    ...
    <div class="sidebar-nav" data-simplebar="true">
        ...
        <ul class="metismenu" id="sidenav">
          ...
          <li>
            <a href="{{ route('sistem-roster.planning.index') }}">
          ...
          <li>
            <a href="{{ route('sistem-roster.dop.index') }}">
              <div class="parent-icon"><i class="material-icons-outlined">checklist</i></div>
              <div class="menu-title">DOP</div>
            </a>
          </li>
          <li>
            <a href="{{ route('sistem-roster.ikk.index') }}">
              <div class="parent-icon"><i class="material-icons-outlined">fact_check</i></div>
              <div class="menu-title">IKK</div>
            </a>
          </li>
          <li>
            <a href="{{ route('sistem-roster.lokasi-non-kritis.index') }}">
              <div class="parent-icon"><i class="material-icons-outlined">report_problem</i></div>
              <div class="menu-title">Lokasi Non Kritis</div>
            </a>
          </li>
          <li>
            <a href="{{ route('sistem-roster.master-aktivitas.index') }}">
